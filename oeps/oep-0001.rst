...
The following examples provide some guidance regarding what makes for a good OEP:

    {idea}
    
This would be a good **Process** proposal because {reason}.

    {idea}
    
This would be not be a good **Process** proposal because {reason}.

    {idea}

This would be a good **Best Practices** proposal because {reason}. 

    {idea}

This would be not be a good **Best Practices** proposal because {reason}.

    {idea}

This would be a good **Architecture** proposal because {reason}. 

    {idea}

This would be not be a good **Architecture** proposal because {reason}.
