...
.. _open-edx-proposals#1: https://github.com/openedx/openedx-proposals/pull/1
.. _open-edx-proposals#53: https://github.com/openedx/openedx-proposals/pull/53
.. _open-edx-proposals#60: https://github.com/openedx/openedx-proposals/pull/60
.. _open-edx-proposals#85: https://github.com/openedx/openedx-proposals/pull/85
.. _open-edx-proposals#1 resolution: https://github.com/openedx/openedx-proposals/pull/1#issuecomment-220419055
...
* OEPs are not used to dictate small decisions made in every day feature work.
  See `OEP-19 <https://docs.openedx.org/projects/openedx-proposals/en/latest/best-practices/oep-0019-bp-developer-documentation.html?highlight=documentation#agile-documentation-types>`_
  for more detail.
...
.. _central OEP repository: https://github.com/openedx/openedx-proposals
...
* `#openedx-proposals Slack channel`_.
...
.. _#openedx-proposals Slack channel: https://openedx.slack.com/messages/C1L370YTZ/details/
...
GitHub issue or draft pull request in the ``openedx-proposals`` repository that
...
Once an OEP has merged to the openedx-proposals repository (which can
...
.. _here: https://github.com/openedx/openedx-proposals/pulls?q=is%3Apr+is%3Aclosed+is%3Aunmerged
...
.. _PEP-based template: https://github.com/openedx/openedx-proposals/tree/master/oep-templates/pep-based-template.rst
.. _ADR-based template: https://github.com/openedx/openedx-proposals/tree/master/oep-templates/adr-based-template.rst
.. _External link template: https://github.com/openedx/openedx-proposals/tree/master/oep-templates/external-link-template.rst
...
* `Pull request #602 <https://github.com/openedx/openedx-proposals/pull/602>`_
...
* `Pull request #601 <https://github.com/openedx/openedx-proposals/pull/601>`_

2024-06-25
==========
* Remove "Withdrawn" status
* `Pull request #597 <https://github.com/openedx/openedx-proposals/pull/597>`_
...
* `Pull request #387 <https://github.com/openedx/openedx-proposals/pull/387>`_
* `Pull request #391 <https://github.com/openedx/openedx-proposals/pull/391>`_

2022-09-23
==========
* Move OEP templates to a top-level directory for better discoverability
* `Pull request #382 <https://github.com/openedx/openedx-proposals/pull/382>`_
...
* `Pull request #326 <https://github.com/openedx/openedx-proposals/pull/326>`_
...
#.
  ...
  * `Pull request #297 <https://github.com/openedx/openedx-proposals/pull/297>`_

#.

  * Add Overview section for greater clarity
  * `Pull request #298 <https://github.com/openedx/openedx-proposals/pull/298>`_

#.

  * Add an at-a-glance section for the Arbiter role
  * `Pull request #299 <https://github.com/openedx/openedx-proposals/pull/299>`_

#.

  * Codify that Process OEPs may be updated
  * `Pull request #300 <https://github.com/openedx/openedx-proposals/pull/300>`_

#.

  * Clarified OEP update procedures
  * `Pull request #301 <https://github.com/openedx/openedx-proposals/pull/301>`_

#.

  * Switch author-ownership model to a community-stewardship one
  * `Pull request #302 <https://github.com/openedx/openedx-proposals/pull/302>`_
...
* `Pull request #284 <https://github.com/openedx/openedx-proposals/pull/284>`_

2020-10-01
==========

* Add a new "Obsolete" status to OEPs
* `Pull request #246 <https://github.com/openedx/openedx-proposals/pull/246>`_
...
* `Pull request #123 <https://github.com/openedx/openedx-proposals/pull/123>`_

2018-11-06
==========

* Added a new "Provisional" status.
* `Pull request #85 <https://github.com/openedx/openedx-proposals/pull/85>`_
...
* `Pull request #60 <https://github.com/openedx/openedx-proposals/pull/60>`_
...
* `Pull request #53 <https://github.com/openedx/openedx-proposals/pull/53>`_
...
* `Pull request #17 <https://github.com/openedx/openedx-proposals/pull/17>`_
...
* `Pull request #19 <https://github.com/openedx/openedx-proposals/pull/19>`_

2016-05-16
==========

* Document created
* `Pull request #1 <https://github.com/openedx/openedx-proposals/pull/1>`_
